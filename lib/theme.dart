...
Color nonactiveColor = const Color(0xff808191);
Color nonprimaryColor = const Color(0xff3F4251);
...
Color dividerColor = const Color(0xff2B2938);
...
TextStyle buttonBuyTextStyle = GoogleFonts.poppins(color: bgColor5);
